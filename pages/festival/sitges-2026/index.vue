  ...
  <main class="main">
    <div class="container header-container">
      <div class="festival-hero">
        ...
        <a href="https://sitgesfilmfestival.com/es" target="_blank" class="hero-backdrop">
            <img
              ref="backdropImgRef"
              src="/festivals/sitges/sitges_backdrop_2026_es.webp"
              alt="Backdrop de Sitges 2026"
        ...
        <div v-if="activeTab === 'films'" class="selection">
          ...
          <div v-if="orderedCategories.length === 0" class="rollout-banner">
            ...
            <div class="rollout-banner__copy">
              <h3>Selección oficial en actualización</h3>
              <p>La selección de este festival está siendo actualizada. Nuevas películas, secciones y selecciones oficiales se incorporarán progresivamente a medida que se anuncien y verifiquen.</p>
            </div>
          </div>
              ...
              >
                <div class="sel-section-header" @click="onSectionHeaderClick(sec.key)">
                  ...
                  <div class="sel-section-meta">
                    ...
                    <button v-if="isMobile" class="expand-btn" :aria-label="isSectionOpen(sec.key) ? 'Colapsar' : 'Expandir'">
          ...
          <div v-if="showSchedulePending" class="schedule-pending">
            <div class="schedule-pending-inner">
              ...
              <p class="schedule-pending-text">
                El festival aún no ha publicado los horarios ni las sedes por función. Cuando difunda el programa oficial, las proyecciones aparecerán aquí automáticamente.
              </p>
            </div>
          </div>
...
<!-- Slide 0: General Information -->
                  <template v-if="infoSlide === 0">
                    ...
                    <p class="carousel-desc"><strong>Sitio oficial:</strong> <a href="https://sitgesfilmfestival.com/es" target="_blank" class="accent-link">sitgesfilmfestival.com</a></p>
                    <p class="carousel-desc">El festival de referencia mundial del cine fantástico, de terror y de ciencia ficción, en marcha desde 1968. Su sección competitiva Oficial Fantàstic convive con Noves Visions para las obras más arriesgadas en lo formal, Òrbita para el thriller y la acción cercanos al género, y Brigadoon, que celebra sus 40 años como la casa del cine de culto e independiente dentro del festival.</p>
                    <p class="carousel-desc">Esta edición toma la infancia y los poderes paranormales como leitmotiv, con <em>Carrie</em> como marco visual y conceptual. Peter Jackson, Danny DeVito y Amy Irving reciben el Gran Premio Honorífico, y Robert Eggers, Yuen Woo-ping, Takashi Shimizu, Bob Murawski y Mark L. Lester el Time Machine Award.</p>
                  </template>
                  ...
                  <template v-if="infoSlide === 2">
                    ...
                    <div class="venue-list">
                      <div class="venue-item"><strong>Auditori Meliá Sitges</strong><span>Sala principal y sede central del festival</span></div>
...
const formatDate = (dateStr) => {
    ...
    return new Date(`${dateStr}T00:00:00Z`).toLocaleDateString('es-ES', options);
};
